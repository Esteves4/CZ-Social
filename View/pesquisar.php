...
<div class="row col-sm-6 col-sm-offset-3">
	<div class="container-fluid input-group input-group-lg" id="group-pesquisa">
		<input type="text" placeholder="Pesquisar Conta" class="form-control" id="barra_pesquisa"></input>
		<div class="input-group-btn"><button type="button" class="btn btn-default" id="btn-pesquisar"><span class="glyphicon glyphicon-search"></span></button></div>
	</div>
</div>

<div class="container-fluid" id="contas"></div>

<span class="btn btn-info center-block" id="carregar_contas">Carregar mais Contas.</span>
